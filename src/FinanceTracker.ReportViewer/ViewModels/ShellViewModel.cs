using FinanceTracker.ReportViewer.Views;
using MahApps.Metro.IconPacks;
using System.Collections.ObjectModel;

namespace FinanceTracker.ReportViewer.ViewModels
{
    public class ShellViewModel : BindableBase
    {
        ...
        public ShellViewModel()
        {
            ...
            {
                Icon = new PackIconFontAwesome() { Kind = PackIconFontAwesomeKind.CodeCommitSolid },
                Label = "Settings",
            ...
            this.OptionsMenu.Add(new MenuItem()
            {
                Icon = new PackIconFontAwesome() { Kind = PackIconFontAwesomeKind.IndentSolid },
                Label = "About",
